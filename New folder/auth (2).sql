...
--
-- Host: 127.0.0.1
-- Czas generowania: 07 Cze 2022, 13:06
...
--
-- Struktura tabeli dla tabeli `loginadmin`
--
...
--
-- Zrzut danych tabeli `loginadmin`
--
...
(14, '2@2', '$argon2i$v=19$m=65536,t=4,p=1$VU9FZmpWQ2VJbHJIaDV4SA$+jloG4HuOfubp+Qvha3UrEqqP3lHX3vLxnbE/8uFpSE', '2', '2'),
(15, '3@3', '$argon2i$v=19$m=65536,t=4,p=1$bTlDaWcyUlc4V290TlluVA$AXihWW/MwOI2UUFpVYNSbtESYqkPCxXfMi+LhRRqEVo', '3', '3');
...
--
-- AUTO_INCREMENT dla tabeli `loginadmin`
--
ALTER TABLE `loginadmin`
